...
HRESULT screenManager::init()
{
	_bg1 = new imageTag;
	_bg2 = new imageTag;
	_bgSlow = new imageTag;
	_bgFast = new imageTag;
	_fireWork1 = new imageTag;
	_fireWork2 = new imageTag;
	_fireWork3 = new imageTag;
	_fireWork4 = new imageTag;
	_fireWork5 = new imageTag;

	_fadeOut1 = new imageTag;
	_fadeOut2 = new imageTag;
...
void screenManager::release()
{
	...
	SAFE_DELETE(_bgSlow);
	SAFE_DELETE(_bgFast);
	SAFE_DELETE(_fireWork1);
	SAFE_DELETE(_fireWork2);
	SAFE_DELETE(_fireWork3);
	SAFE_DELETE(_fireWork4);
	SAFE_DELETE(_fireWork5);
	SAFE_DELETE(_fadeOut1);
	SAFE_DELETE(_fadeOut2);
}
